...
print(model.is_training, model.is_kv_cache)
...
#     table.append([
#         avg.key,
#         avg.cpu_time_total / (1000*60*60),
#         avg.cuda_time_total / (1000 *60*60),
#         avg.cpu_memory_usage / 1024,
#         avg.cuda_memory_usage/ 1024,
#         avg.flops,
#     ])
...
# print("\nTotals:")
# print(f"Total CPU Time: {total_cpu_time:.6f} hrs")
# print(f"Total CUDA Time: {total_cuda_time:.6f} hrs")
# print(f"Total CPU Memory: {total_cpu_memory:.6f} GB")
# print(f"Total CUDA Memory: {total_cuda_memory:.6f} GB")
